...
MAPPING: list[tuple[str, str, tuple[str, ...]]] = [
    ...
    ("health-food-cover.jpg", "低保真原型图.png", ("UI设计稿",)),
    ("health-food-logo.png", "2220048_秦艺榕_首页.png", ("UI设计稿",)),
    ...
    ("health-food-bubble.png", "低保真原型图.png", ("UI设计稿",)),
    ("health-food-rank.png", "2220048_秦艺榕_工作台.png", ("UI设计稿",)),
    ("medical-sitemap.png", "2220048_秦艺榕_个人主页截图.png", ("Web页面截图",)),
    ("medical-sitemap.png", "2220048_秦艺榕_个人主页截图.png", ("页面截图",)),
    ("medical-home.jpg", "首页.jpg", ("健康医疗网站", "低配")),
