...
def main() -> int:
    ...
    for name, patterns in [
        ...
        ("opera-1.mp4", ((("梨园之韵",), "京剧1.mp4"), (("作品集", "信息可视化"), "京剧1.mp4"), (("信息可视化",), "京剧1.mp4"))),
        ("opera-2.mp4", ((("梨园之韵",), "京剧2.mp4"), (("作品集", "信息可视化"), "京剧2.mp4"), (("信息可视化",), "京剧2.mp4"))),
        ("opera-3.mp4", ((("梨园之韵",), "京剧3.mp4"), (("作品集", "信息可视化"), "京剧3.mp4"), (("信息可视化",), "京剧3.mp4"))),
        ("revised-full.mp4", ((("梨园之韵",), "京剧修改后.mp4"), (("作品集", "信息可视化"), "京剧修改后.mp4"), (("信息可视化",), "京剧修改后.mp4"))),
        ("revised-short.mp4", ((("梨园之韵",), "京剧修改后_1.mp4"), (("作品集", "信息可视化"), "京剧修改后_1.mp4"), (("信息可视化",), "京剧修改后_1.mp4"))),
    ]:
    ...
    campus = [
        ...
        ("ui-defense.mp4",
         ...
         (("UI设计",), "录屏文件.mp4")),
        ("liyuan-short.mp4", (("06-视频精选", "梨园"), "梨园.mp4"), (("梨园",), "梨园.mp4"), (("梨园之韵",), "梨园.mp4")),
    ]
    for item in campus:
