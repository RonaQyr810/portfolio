document.addEventListener('DOMContentLoaded', () => {
  ...
  const galleries = {
    looptrace: [
      ...
      { src: 'assets/portfolio/looptrace-profile.png', caption: '环溯 LoopTrace · 个人主页' },
      { src: 'assets/portfolio/looptrace-shop.png', caption: '环溯 LoopTrace · 商城' },
      { src: 'assets/portfolio/looptrace-contribute.png', caption: '环溯 LoopTrace · 循环贡献' },
      { src: 'assets/portfolio/looptrace-confirm.png', caption: '环溯 LoopTrace · 确认订单' },
      { src: 'assets/portfolio/looptrace-settings.png', caption: '环溯 LoopTrace · 设置' },
    ],
    'health-food': [
      { src: 'assets/portfolio/health-food-logo.png', caption: '健康食途 · APP 图标 · 开屏' },
    ...
    brand: [
      { src: 'assets/portfolio/brand-logo-main.png?v=7', caption: '品牌视觉设计 · 主 LOGO 方案' },
      { src: 'assets/portfolio/brand-logo-alt.png?v=7', caption: '品牌视觉设计 · LOGO 变体（QYR + 鱼形笔画）' },
      { src: 'assets/portfolio/brand-logo-restored.png?v=7', caption: '品牌视觉设计 · LOGO 精修版' },
    ],
    'brand-ui': [
      { src: 'assets/portfolio/brand-ui/wireframe.png?v=1', caption: '品牌视觉设计 · UI 低保真原型图' },
      { src: 'assets/portfolio/brand-ui/home.png?v=1', caption: '品牌视觉设计 · 首页' },
      { src: 'assets/portfolio/brand-ui/home-revised.png?v=1', caption: '品牌视觉设计 · 首页（修改版）' },
      { src: 'assets/portfolio/brand-ui/list.jpg?v=1', caption: '品牌视觉设计 · 列表页' },
      { src: 'assets/portfolio/brand-ui/list-shot.png?v=1', caption: '品牌视觉设计 · 列表页截图' },
      { src: 'assets/portfolio/brand-ui/workbench.png?v=1', caption: '品牌视觉设计 · 工作台' },
      { src: 'assets/portfolio/brand-ui/profile.png?v=1', caption: '品牌视觉设计 · 我的' },
      { src: 'assets/portfolio/brand-ui/profile-revised.png?v=1', caption: '品牌视觉设计 · 我的（修改版）' },
      { src: 'assets/portfolio/brand-ui/homework-1.png?v=1', caption: '品牌视觉设计 · 课程作业 1' },
      { src: 'assets/portfolio/brand-ui/homework-2.png?v=1', caption: '品牌视觉设计 · 课程作业 2' },
      { src: 'assets/portfolio/brand-ui/sculpture-poster.png?v=1', caption: '品牌视觉设计 · 雕塑设计海报（学无止境步步高升）' },
      { src: 'assets/portfolio/brand-ui/app-icon.png?v=1', caption: '品牌视觉设计 · APP 图标' },
    ],
    'peking-opera': [
